        ...
        <div className="mt-10 grid md:grid-cols-2 gap-6">
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="p-6 rounded-2xl bg-white dark:bg-[#0b1220] border border-[#0056D2]/10 shadow-[0_10px_30px_rgba(0,0,0,0.05)]">
            <div className="space-y-4">
              <a href="tel:9730299895" className="flex items-center gap-3 text-[#0D1B2A] dark:text-blue-100 hover:text-[#0056D2]">
                <Phone className="text-[#0056D2]" size={18} /> 9730299895
              </a>
              <a href="mailto:garadprathamesh98@gmail.com" className="flex items-center gap-3 text-[#0D1B2A] dark:text-blue-100 hover:text-[#0056D2]">
                <Mail className="text-[#0056D2]" size={18} /> garadprathamesh98@gmail.com
              </a>
              <a href="https://github.com/Prathamesh-98" target="_blank" className="flex items-center gap-3 text-[#0D1B2A] dark:text-blue-100 hover:text-[#0056D2]">
                <Github className="text-[#0056D2]" size={18} /> github.com/Prathamesh-98
              </a>
              <a href="https://linkedin.com/in/prathamesh-garad-1748a3287" target="_blank" className="flex items-center gap-3 text-[#0D1B2A] dark:text-blue-100 hover:text-[#0056D2]">
                <Linkedin className="text-[#0056D2]" size={18} /> linkedin.com/in/prathamesh-garad-1748a3287
              </a>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="p-6 rounded-2xl bg-white dark:bg-[#0b1220] border border-[#0056D2]/10 shadow-[0_10px_30px_rgba(0,0,0,0.05)]">
            <form className="space-y-4">
              ...
              <button type="button" className="w-full px-6 py-3 rounded-xl bg-gradient-to-r from-[#0056D2] to-[#00C4FF] text-white font-semibold shadow-[0_8px_30px_rgba(0,86,210,0.35)] hover:shadow-[0_8px_40px_rgba(0,196,255,0.45)] transition">Send Message</button>
            </form>
          </motion.div>
        </div>
      </div>
